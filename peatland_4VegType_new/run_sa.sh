...
# SA runs
python3 Multi_ECH2O.py  --mode sensi_morris --MSinit 0 --MSspace radial --NumTraj 5 --file def_50m_sa.py --outdir outputs.1 --ncpu 1 --Resol 50  --exe ech2o_iso --cfg config_sa --isTrck 1 --nthreads 1
