...
#    ref['Rt_Crops']  = {'soil':0, 'veg':0, 'log':0,'min':100, 'max':1000,'file':'root_0'}
    ...
    # ref['CanopyQuantumEffic']   = {'soil':0, 'veg':1, 'log':1,'min':[1e-7,1e-7,1e-7,1e-7], 'max':[1e-5,1e-5,1e-5,1e-5]}
    ref['CanopyQuantumEffic']   = {'soil':0, 'veg':1, 'log':1,'min':[1e-7,1e-7,1e-7,1e-7], 'max':[1.5e-2,1.5e-2,1.5e-2,1.5e-2]}
    ref['OptimalTemp']      = {'soil':0, 'veg':1, 'log':0,'min':[5,5,5,5],    'max':[25,25,25,25]}
    ref['MaxTemp']      = {'soil':0, 'veg':1, 'log':0,'min':[25,25,25,25],   'max':[40,40,40,40]}
    ref['MinTemp']      = {'soil':0, 'veg':1, 'log':0,'min':[-5,-5,-5,-5],   'max':[5,5,5,5]}
    ref['FoliageAllocCoef_a']={'soil':0, 'veg':1, 'log':0,'min':[1.5,1.5,1.5,1.5],  'max':[3,3,3,3]}
    ref['FoliageAllocCoef_b']={'soil':0, 'veg':1, 'log':1,'min':[1e-3,1e-3,1e-3,1e-3], 'max':[5e-2,5e-2,5e-2,5e-2]}
    ref['StemAllocCoef_a']={'soil':0, 'veg':1, 'log':0,'min':[2,2,2,2],    'max':[4,4,4,4]}
    ref['StemAllocCoef_b']={'soil':0, 'veg':1, 'log':1,'min':[1e-8,1e-8,1e-8,1e-8], 'max':[9e-6,9e-6,9e-6,9e-6]}
    ...
    ref['WiltingPnt']   = {'soil':0, 'veg':1, 'log':0,'min':[0.01,0.01,0.01,0.01], 'max':[0.05,0.05,0.05,0.05]}
    ref['SpecificLeafArea']       = {'soil':0, 'veg':1, 'log':1,'min':[1e-5,1e-5,1e-5,1e-5], 'max':[5e-2,5e-2,5e-2,5e-2]}
    ref['SpecificRootArea']       = {'soil':0, 'veg':1, 'log':1,'min':[1e-5,1e-5,1e-5,1e-5], 'max':[5e-2,5e-2,5e-2,5e-2]}
    # #ref['WoodDens']  = {'soil':0, 'veg':1, 'log':0,'min':[],'max':[]}
    ref['Fhdmax']    = {'soil':0, 'veg':1, 'log':0,'min':[11,11,11,11],   'max':[500,500,500,500]}
    ref['Fhdmin']    = {'soil':0, 'veg':1, 'log':0,'min':[1,1,1,1],    'max':[20,20,20,20]}
    ref['LeafTurnoverRate']   = {'soil':0, 'veg':1, 'log':1,'min':[1e-9,1e-9,1e-9,1e-9], 'max':[1e-7,1e-7,1e-7,1e-7]}
    ref['MaxLeafTurnoverWaterStress']= {'soil':0,'veg':1, 'log':1,'min':[1e-9,1e-9,1e-9,1e-9], 'max':[1e-7,1e-7,1e-7,1e-7]}
    ref['LeafTurnoverWaterStressParam']= {'soil':0,'veg':1, 'log':1,'min':[1e-9,1e-9,1e-9,1e-9], 'max':[0.5,0.5,0.5,0.5]}
    ref['MaxLeafTurnoverTempStress']= {'soil':0,'veg':1, 'log':1,'min':[1e-9,1e-9,1e-9,1e-9], 'max':[1e-7,1e-7,1e-7,1e-7]}
    ref['LeafTurnoverTempStressParam']= {'soil':0,'veg':1, 'log':1,'min':[1e-9,1e-9,1e-9,1e-9], 'max':[0.5,0.5,0.5,0.5]}
    ref['ColdStressParam']= {'soil':0,'veg':1,'log':0,'min':[-5,-5,-5,-5],   'max':[5,5,5,5]}
    ref['RootTurnoverRate']   = {'soil':0, 'veg':1, 'log':1,'min':[1e-9,1e-9,1e-9,1e-9], 'max':[1e-7,1e-7,1e-7,1e-7]}
    ...
    # # energy balance
    ref['albedo']    = {'soil':0, 'veg':1, 'log':0,'min':[0.1,0.1,0.1,0.1],  'max':[0.25,0.25,0.25,0.25]}
    ref['emissivity']= {'soil':0, 'veg':1, 'log':0,'min':[0.9,0.9,0.9,0.9],  'max':[0.99,0.99,0.99,0.99]}
    ref['KBeers']    = {'soil':0, 'veg':1, 'log':0,'min':[0.1,0.1,0.1,0.1],  'max':[1,1,1,1]}
    ref['CanopyWatEffic']   = {'soil':0, 'veg':1, 'log':0,'min':[500,500,500,500],  'max':[5000,5000,5000,5000]}
